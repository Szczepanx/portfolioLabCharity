      ...
      <div class="form--steps-container">
        ...
        <form:form action="form-confirmation.jsp" method="post" modelAttribute="donation" >
          ...
          <div data-step="1" class="active">
            ...
            <div class="form-group form-group--checkbox">
              <label>
                <form:checkbox  name="categories" value="toys"  path="categories"/>
                <span class="checkbox"></span>
            ...
            <div class="form-group form-group--checkbox">
              <label>
                <form:checkbox  name="categories" value="books"  path="categories"/>
                <span class="checkbox"></span>
            ...
            <div class="form-group form-group--checkbox">
              <label>
                <form:checkbox  name="categories" value="other"  path="categories"/>
                <span class="checkbox"></span>
          ...
          <div data-step="3">
            ...
            <div class="form-group form-group--checkbox">
              <label>
                <form:radiobutton name="organization" value="old"  path="institution"/>
